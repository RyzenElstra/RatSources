...
uses
  SysUtils, GeoIP, UnitVariables;
              
function GeoIpCountryName(Ip: string): string;
function GeoIpFlagIndex(Ip: string): Integer;
function GetFlagIndex(CountryCode: string): Integer;
function GetCountryName(CountryCode: string): string;
function GeoIpLatitude(Ip: string): string;
function GeoIpLongitude(Ip: string): string;
function GeoIpRegionName(Ip: string): string;  
function GeoIpCityName(Ip: string): string;
function GeoIpZipCode(Ip: string): string;
