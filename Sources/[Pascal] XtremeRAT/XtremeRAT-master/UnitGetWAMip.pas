...
begin
  ...
  if result = '' then result := '127.0.0.1' else Delete(result, 1, (pos('Current IP Address: ', result) - 1) + length('Current IP Address: '));
...

{
  ...
  if result = '' then result := '127.0.0.1' else Delete(result, 1, ((pos(#13#10#13#10, result) - 1) + 4));
