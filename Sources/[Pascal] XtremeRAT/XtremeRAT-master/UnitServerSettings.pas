...
begin
  ...
  InstalledServer := Copy(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, length(DelimitadorComandos));

  ProcessoAtual := Copy(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, length(DelimitadorComandos));

  ServerStarted := Copy(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, pos(DelimitadorComandos, Settings) - 1);
  Delete(Settings, 1, length(DelimitadorComandos));
