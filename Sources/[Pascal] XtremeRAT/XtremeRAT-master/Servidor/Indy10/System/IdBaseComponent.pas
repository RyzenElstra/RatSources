...
type
  ...
  {$IFDEF DOTNET}
  //IMPORTANT!!!
  //Abstract Classes, StreamUnit should be hidden in the assembly designer.
...
begin
  ...
  // Classes, StreamUnit in the assembly, and for each one named Unit we call the class constructor which
