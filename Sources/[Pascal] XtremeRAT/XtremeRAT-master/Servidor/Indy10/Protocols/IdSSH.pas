...
{
  Note that this unit is for defining Base Classes, StreamUnit for SSH implementers.

  Much of this is a Cut and Paste job from Indy 10's Base SSL Classes, StreamUnit.  We make
