{
  ...
  10. Move all TIdTextModeResourceRecord and derived Classes, StreamUnit to IdDNSCommon.pas
  ...
  Update the TextRecord function of all TIdRR_ Classes, StreamUnit, it checks if the RRName
