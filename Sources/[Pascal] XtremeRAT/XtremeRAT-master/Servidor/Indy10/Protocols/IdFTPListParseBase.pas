...
}
{
  ...
  Added method for getting all of the identifiers for the parsing Classes, StreamUnit for
  ego purposes only :-).
  ...
  Fixed bug that appears in some descendant Classes, StreamUnit.  TIdFTPListBaseHeader
...
type
  //We don't want to create instances of these Classes, StreamUnit and
  //these Classes, StreamUnit should not contain variables accross procedures
