...
This class is not useful in and of itself.  It is for deriving descendant Classes, StreamUnit
for implementing reusable SASL authentication mechanism Classes, StreamUnit for components
such as IdPOP3, IdSMTP, and IdIMAP4.

But since they tie into the SASLList, its not restricted to message clients.

Descendant Classes, StreamUnit will be responsible for implementing the SASL mechanism
