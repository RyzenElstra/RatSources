...
begin
  Result := false;
  TempStr := Copy(Str, 1, pos(delimitadorComandos, Str) - 1);
  Delete(Str, 1, pos(delimitadorComandos, Str) - 1);
  ...
  Nome := Copy(Str, 1, pos(delimitadorComandos, Str) - 1);
  Delete(Str, 1, pos(delimitadorComandos, Str) - 1);
  Delete(Str, 1, length(delimitadorComandos));

  Tipo := Copy(Str, 1, pos(delimitadorComandos, Str) - 1);
  Delete(Str, 1, pos(delimitadorComandos, Str) - 1);
  Delete(Str, 1, length(delimitadorComandos));
