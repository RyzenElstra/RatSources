...
type
  ...
  public
    ...
    procedure SendBuffer(const ABuffer: TBytes; const AReceiverID: string);
...
procedure TConexaoNew.BroadcastBuffer(const ABuffer: TBytes);
var
  Index: Integer;
  LClients: TList;
...
procedure TConexaoNew.SendBuffer(const ABuffer: TBytes; const AReceiverID: string);
var
  Index: Integer;
  LClients: TList;
  LConexao: TConexaoNew;
