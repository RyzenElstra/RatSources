...
type
  ...
  public
    ...
    function Idle(Seconds: Integer): Integer;
...
begin
  ...
  if Winsock.Connect(FSocket, SockAddrIn, SizeOf(SockAddrIn)) = S_OK then FConnected := True;
end;
...
function TClientSocket.Idle(Seconds: Integer): Integer;
var
  FDset: TFDset;
  TimeVal: TTimeVal;
begin
...
begin
  ...
  GetMem(BinaryBuffer, 4096);
  try
    repeat
      Sleep(1);
      ReadFile(BinaryFile, BinaryBuffer^, 4096, BytesRead, nil);
