...
Namespace Xanity_2._0
    Friend Class FlatClose
        ...
        Private Shared Sub __ENCAddToList(ByVal value As Object)
            Dim list As List(Of WeakReference) = FlatClose.__ENCList
            SyncLock list
                If (FlatClose.__ENCList.Count = FlatClose.__ENCList.Capacity) Then
                    ...
                    Dim i As Integer = 0
                    Do While (i <= num3)
                        Dim reference As WeakReference = FlatClose.__ENCList.Item(i)
                        If reference.IsAlive Then
                            If (i <> index) Then
                                FlatClose.__ENCList.Item(index) = FlatClose.__ENCList.Item(i)
                            End If
                            index += 1
                        End If
                        i += 1
                    Loop
                    FlatClose.__ENCList.RemoveRange(index, (FlatClose.__ENCList.Count - index))
